...
import {AddressItem, Button, Loader, Text} from 'components';
...
const RenderItem = ({item, onSelect}: ICheckoutAddress) => {
  return (
    <AddressItem item={item} isSelectAddress={true} onPressAddress={onSelect} />
  );
};
...
const CheckoutFirstStep = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Button title="addAddress.submitBtn" />
    </View>
  );
};
